...
class MenteeSignUpForm(FlaskForm):
    first_name = StringField("First name:")
    last_name = StringField("Last name:")
    email = StringField('Email address', validators=[DataRequired(), Email()])
...
class PersonalForm(FlaskForm):
    ...
    hobbies = SelectMultipleField('', choices=choices1)
    # personality #
    ...
    personal_issues = SelectMultipleField('Which of the following do you relate to?', choices=choices3)
    ...
    choices6 = [('Engineering', 'Engineering'),
                ...
                ('Medicine', 'Medicine'),
                ('Sports', 'Sports')]
    # mentor_field = SelectMultipleField('What field does your occupation lie in?', choices=choices6)

    field = SelectMultipleField(choices=choices6)
