...
def search_results(search, user_type):
    ...
    if select_string == '':
        ...
        if not user:
            ...
            return redirect('/admin/view_{}s'.format(user_type))
        return render_template('admin/all.html'.format(select_string), title='Search Results',
...
def school_signup():
    ...
    return render_template('admin/../templates/forms/school_signup.html', form=form)
