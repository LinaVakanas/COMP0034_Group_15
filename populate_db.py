from app import db
from app.models2_backup import User, Mentee, Mentor, Location, Meeting, Pair, School, Admin
...
def populate_db():
    ...
    school2 = School(school_status=1, school_id=2, school_name='Westminster City School', school_email="wcsch@hotmail.com",
                     ofsted_ranking="2")
    user1 = User(user_type='mentor', school_id=0, email='harrypj@ucl.ac.uk', active=True)
    user1.set_password('password1')
    mentor = Mentor(user_id=1, school_id=0, first_name='Harry', last_name='Potter', paired=True)
    user2 = User(user_type='mentee', school_id=1, email='lily@ucl.ac.uk', active=True)
    ...
    user5 = User(user_type='mentor', school_id=0, email='larry_jake@gmail.com', active=False)
